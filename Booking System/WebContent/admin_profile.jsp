...
<body>
  ...
  <div class="middle-content text-center">
    ...
    <input type="button" value="Manage Movies" onclick="manageMovie">
    <input type="button" value="Manage Users" onclick="manageUserInfo">
    <input type="button" value="Manage Employees" onclick="manageEmployeeInfo">
    <input type="button" value="Manage Ticket/Promotions" onclick="managePromotions">
    <input type="button" value="View Sales Report" onclick="viewSales">
  </div>
<div class="container">
