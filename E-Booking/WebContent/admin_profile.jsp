...
<ul class="nav nav-pills justify-content-center">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="admin_profile.jsp">View Sales Report</a>
  </li>
</ul> 	

<div class="container">
  <div class="bottom-content">
    <h2 style="text-align:center; margin: 0;"> Sales Report
      <select style="float: right; margin: 0;">
        <option>Daily</option><option>All</option><option>Movie 3</option>
      </select></h2>

    <p>Revenue: $45,000</p><br>
    <p>Ticket Sold: 100</p><br>
  </div>
</div>
  <script></script>
</body>
