...
<jsp:useBean id="dbConn" class="config.DBConnection" scope="session">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <% if (user.getCurrUserId() == -1) {  %>
	   ...
	   <% } else { %>
	   	   <ul class="navbar-nav">
	        <li class="nav-item">
	          <button onclick="<% user.logout();%>http://localhost:8080/E-Booking/index.jsp"><i class="fas fa-user-circle"></i>Logout</button>
	        </li>
	      </ul>
	   <% } %>
