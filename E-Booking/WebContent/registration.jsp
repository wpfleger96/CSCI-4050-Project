...
<body>
  ...
  <div class="form-content">
    ...
    <form class="form-control" method="POST" action="http://localhost:8080/E-Booking/registration_results.jsp">
      <div class="row">
		<div class="col-md">
			<!-- First Name  -->
      		<div class="row">
      		...
      		<div class="row">
      			<div class="col">
          			...
          			<input type="text" class="form-control form-element col-md" id="street" name="street" placeholder="Street">
          			<input type="text" class="form-control form-element col-md-5" id="city" name="city" placeholder="City">
          			<input type="text" class="form-control form-element col-md-5" id="state" name="state" placeholder="State">
      			</div>
      		</div>
      		<!-- Phone -->
      		<div class="row">
      ...
      <input type="radio" name="promo" id="promo" checked value="Yes">Yes
      <input type="radio" name="promo" id="promo" value="No">No<br>
      <br>
